        ...
        <Link href={"/products/" + product.permalink}>
            <div className="flex flex-col justify-center items-center w-full rounded-xl drop-shadow-md hover:cursor-pointer"
                ...
                <div className={isHovering ?
                    "flex flex-col justify-center bg-gray-100 rounded-xl h-[350px] items-center mx-auto w-full transition duration-300 md:h-[250px] lg:h-[350px]" :
                    "flex flex-col justify-center bg-gray-300 rounded-xl h-[350px] items-center mx-auto w-full transition duration-300 md:h-[250px] lg:h-[350px]"}>
                ...
                <div className="w-full mt-5">
                    <h5>{product.name}</h5>
                    <p className="">{product.price.formatted_with_code}</p>
                </div>
            </div>
        </Link>
    );
